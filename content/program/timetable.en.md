...
- IS-1-026: Daiki Kimura (IBM Research)*; Naomi Simumba (IBM Research); Marcus Freitag (IBM Research); Johannes Schmude (IBM); Linsong Chu (IBM Research); Daniela Szwarcman (IBM Research); Johannes Jakubik (IBM Research); Paolo Fraccaro (IBM UK); Carlos Gomes (IBM Research	); Dario Oliveira (IBM); Michal Muszynski (IBM Research); Michiaki Tatsubori (IBM Research - Tokyo), **"Geospatial Foundation Model by Diversified Data"**
...
- IS-1-089: Sho Takahashi (Tohoku University)*; Tomo Miyazaki (Tohoku University); Shinichiro Omachi (Tohoku University), **"インスタンスセグメンテーションを用いた複雑性除去による異常検知手法 (Anomaly detection method using instance segmentation for complexity removal)"**
...
- IS-1-096: Taiga Masuda (Chubu Univ.)*; Hiroki Adachi (Chubu University); Tsubasa Hirakawa (Chubu University); Takayoshi Yamashita (Chubu University); Hironobu Fujiyoshi (Chubu Univ.); Shohei Tanaka (OMRON SINIC X Corporation); Kuniaki Saito (OMRON SINIC X); Yoshitaka Ushiku (OMRON SINIC X Corp.), **"Attention weightの操作による注目領域に着目したグラフ図のキャプション生成 (Figure Captioning Focused on the Attention Region by Manipulating Attention Weights)"**
...
- IS-1-101: Ii Mizuki (Toyohashi University of Technology); Yasushi Kanazawa (Toyohashi University of Technology)*, **"自動追尾スポットライトシステムのための連携行動による新郎新婦の追跡 (Bride and Groom Tracking by Cooperated Action for Automatic Tracking Spotlight System)"**
...
- IS-1-106: Hiroko Yamabe (Ritsumeikan Univ.)*, **"生成AIによる人物画像に対する真贋判定技術の検討 (Authenticity determination method for human face by using generative AI)"**
- IS-1-107: Shun Ozaki (Tohoku University)*; Shinichiro Omachi (Tohoku University); Tomo Miyazaki (Tohoku University); Yasuhisa Fujii (Google), **"フレームのキャプショニングを用いた動画要約学習 (Training of video Summarization with frame captioning)"**
...
- IS-1-113: Naoto Inoue (CyberAgent)*; Kento Masui (CyberAgent); Wataru Shimoda (CyberAgent.Inc); Kota Yamaguchi (CyberAgent), **"OpenCOLE: Towards Reproducible Automatic Graphic Design Generation"**
- IS-1-114: Maki Iritani (名古屋工業大学); Fumihiko Sakaue (Nagoya Institute of Technology); Jun Sato (Nagoya Institute of Technology)*, **"イラスト画像における自動着彩とレイヤー分割 (Automatic Coloring and Layering for Illustration Images)"**
- IS-1-115: 加藤恩妃, 久保田彰 (中大), **"ゼロショット学習を用いた，可視光画像と近赤外線画像の融合による靄除去"**
- IS-1-116: 伊藤泰希, 武藤良, 植木一也 (明星大), **"大規模マルチモーダルモデルを用いた画像内における潜在リスクの検知"**
- IS-1-117: Yongsong HUANG (Tohoku University)*; Tomo Miyazaki (Tohoku University); Xiaofeng Liu (Yale University); Zhengmi  TANG (Tohoku University); Kaiyuan  JIANG (Tohoku University); Yaohou Fan (Tohoku University); Dongming  YU (Tohoku University); Shinichiro Omachi (Tohoku University), **"Radiograph Super-Resolution with Pixel-Level Masked D-MNet Transformer"**
- IS-1-118: Yingxin Yan (Nagoya Institute of Technology); Fumihiko Sakaue (Nagoya Institute of Technology); Jun Sato (Nagoya Institute of Technology)*, **"事前ぼけ復元を用いた視力推定と仮想矯正 (Visual Acuity Estimation and Correction by using Pre-Deblurring)"**
...
- IS-1-121: JIATONG ZHANG (waseda university)*; Sei-ichiro Kamata (waseda university), **"Advanced Feature Fusion Networks for 3D Hand Reconstruction from Single Image"**
- IS-1-122: YUTO SHIBATA (Keio university)*; Yusuke Oumi (Keio University); Go Irie (Tokyo University of Science); Akisato Kimura (NTT Corporation); Yoshimitsu Aoki (Keio University); Mariko Isogawa (Keio University), **"BGM2Pose: Active 3D Human Pose Estimation with Background Music"**
- IS-1-123: Qianru Qiu (CyberAgent, Inc.)*; Jiafeng Mao (CyberAgent, Inc.); Xueting Wang (CyberAgent, Inc.), **"ControlColor: Palette-Guided Image Colorization with Latent Diffusion Models"**
- IS-1-124: Chen FU (The University of Tokyo)*; Yuesong Liu (Septeni, Inc.); Naoto Tanji (Septeni, Inc.); Hiroyuki Seshime Seshime (Septeni, ); Shengzhou Yi (The University of Tokyo); Ling Xiao (The university of Tokyo); Toshihiko Yamasaki (The University of Tokyo), **"Constrianed advertisement layout generation based on Graph Neural Networks"**
- IS-1-125: 今泉健太, 宮川和, 深津真二 (NTT), **"映像情報を用いた音源分離による空間再構成"**
- IS-1-126: Kazuoki Nagatomo (Waseda University)*; Hiroshi Ishikawa (Waseda University), **"AOSAを用いた投手の牽制球と投球の分類根拠の可視化 (Visualization of Classification Criteria for Pitcher's Pickoff Throws and Pitches Using AOSA)"**
- IS-1-127: Liangyang Ouyang (The University of Tokyo)*; Ruicong Liu (The University of Tokyo); Yifei Huang (The University of Tokyo); Ryosuke Furuta (The University of Tokyo); Yoichi Sato (University of Tokyo), **"ActionVOS: Actions as Prompts for Video Object Segmentation"**
- IS-1-128: Ryoma Takehara (Keio University); Yoshihisa Shinozawa (Keio University)*; Yukako Iimura (Nippon Telegraph and Telephone Corporation); Shinobu Saito (Nippon Telegraph and Telephone Corporation), **"少量データを用いたスクリーンショット画像からのUIパーツ検出方法 (Detection of UI parts from Screenshots with Small Dataset)"**
- IS-1-129: isao wakabayashi (YANMAR Holdings Co., Ltd.)*; yuichiro dake (YANMAR Holdings Co., Ltd.); hisashi sugiura (YANMAR Holdings Co., Ltd.), **"魚体追跡と計数領域を用いた魚数カウントシステムの開発 (Development of fish counting system using fish tracking and counting area)"**
- IS-1-130: Motoharu Sonogashira (RIKEN)*; Masaaki Iiyama (Shiga University); Yasutomo Kawanishi (RIKEN), **"Pseudo-label-based training for unknown-aware scene graph generation"**
- IS-1-131: Rento Yamaguchi (University of Electro-Communications)*; Keiji Yanai (The University of Electro-Communications, Tokyo), **"MM-DiTベースのStable Diffusion 3によるゼロショット領域分割 (Zero-shot Segmentation by the MM-DiT Based Stable Diffusion 3)"**
- IS-1-132: Tomoyuki Suzuki (CyberAgent, Inc.)*; Jan Zdenek (CyberAgent); Kota Yamaguchi (CyberAgent), **"グラフィックデザイン再編集のためのテキスト分離に向けて (Towards Text Decomposition for Graphic Design Re-editing)"**
- IS-1-133: 岡田啓佑, 小林智哉, 奥野弘嗣 (阪工大), **"Border-Ownership選択性細胞の応答特性に学んだ図地分離アルゴリズムの性能評価"**
- IS-1-134: Yuta Goto (Tokyo University of Science)*; Satoshi Yamazaki (NEC Visual Intelligence Research Laboratories); Takashi Shibata (NEC Corporation); Jianquan Liu (NEC Corporation), **"Open-vocabulary Scene Graph Generation via Synonym-based Predicate Descriptor"**
- IS-1-135: 隅山慎, 吉澤真太郎, 森優人 (トヨタ自動車), **"交差点におけるオクルージョンに頑健なMultiple Object Trackingの提案"**
- IS-1-136: Haiyang Liu (The University of Tokyo)*; Xingchao Yang (Cyberagent, Inc); Shigeru Kuriyama (CyberAgent); Takafumi Taketomi (CyberAgent), **"VideoMotionGraph++: Co-Speech Gesture Video Reenactment with Blending Diffusion Model and Neural Rhythm Embedding"**
- IS-1-137: 島田泰智 (室蘭工大), 平澤宏祐 (コニカミノルタ), 近藤敏志 (室蘭工大), **"物体検出における特徴量距離を考慮した学習データ選択方法"**
- IS-1-138: Qingrui Hu (Nagoya University)*; Atom Scott (Nagoya University); Calvin Yeung (Nagoya University); Keisuke Fujii (Nagoya University / RIKEN), **"Basketball-SORT: A Multi-Object Tracking Algorithm for Complex Occlusions in Basketball"**
- IS-1-139: Ryuichi Tomiya (Kobe University)*; Yoshihisa Katsube (株式会社イーグリッド); Fernando Roversi (	株式会社イーグリッド); Yoshihiro Omura (株式会社イーグリッド); Ryoichi Takashima (Kobe University); Tetsuya  Takiguchi (Kobe University), **"Multi-Object Trackingを用いた道路損傷検出 (Road Damage Detection using Multi-Object Tracking)"**
...
- IS-1-145: Shun Takashige (ETH Zurich)*; Hermann Blum (ETH Zurich); Marc Pollefeys (ETH Zurich / Microsoft), **"Ontology-based evaluation for truly open-vocabulary segmentation"**
- IS-1-146: 田上鈴奈, 小林大起, 秋月秀一, 橋本学 (中京大), **"画像クラスタリングに基づくincorrectペアの生成によるCLIPモデルの対照学習性能の向上"**
- IS-1-147: Masaya Sato (Hokkaido University)*; Keisuke Maeda (Hokkaido University); Ren Togo (Hokkaido University); Takahiro Ogawa (Hokkaido University); Miki Haseyama (Hokkaido University), **"Identify-and-generate: VQAにおける大規模マルチモーダルモデルの獲得知識と視覚情報の統合強化 (Identify-and-generate: Enhancing the integration of acquired knowledge and visual information in LMMs for VQA)"**
- IS-1-148: Zongyao Li (NEC Corporation)*; Thao-Nhu Nguyen (Dublin City University); Satoshi Yamazaki (NEC Visual Intelligence Research Laboratories); Jianquan Liu (NEC Corporation); Cathal Gurrin (Dublin City University), **"Enhancing Video Moment Retrieval with Scene Graphs"**
- IS-1-149: 熊本優斗, 大谷健登 (名大), 鈴木大輝, 山高大乗 (デンソー), 武田一哉 (名大), **"注視領域と視行動を用いた運転手の注意散漫検出"**
- IS-1-150: Ryo Fujii (Keio University)*; Ryo Hachiuma (NVIDIA); Hideo Saito (Keio University), **"Is Tracking Necessary for the Trajectory Prediction?"**
- IS-1-151: Kazuki Matsumoto (Fukuoka University); Yudai Inoue (Fukuoka University); Da LI (Fukuoka University); Shintaro Ono (Fukuoka University)*, **"時空間画像処理を用いた車載カメラ映像からの先行車両のインペイント (Inpainting of a preceding vehicle from in-vehicle camera video using spatio-temporal image processing)"**
- IS-1-152: chenxi shen (Kyushu university)*; Takafumi Iwaguchi (Kyushu Univ.); Shaodi You (University of Amsterdam); Masateru Kawakubo (Kyushu university); Michinobu Nagao (Tokyo Women's Medical University); Hiroshi Kawasaki (Kyushu univ.), **"Myocardial Flow Reserve Estimation from 4D-Coronary-CT using Deep Neural Network"**
- IS-1-153: Allam Shehata (Osaka University, Japan; Electronics Research Institute, Egypt)*; Prof. Yasushi Yagi (Osaka University), **"Towards a Deep-3DMM Reversible Face de-identification  Framework"**
- IS-1-154: Xiang Li (Osaka University)*; Chi Xu (Osaka University); Prof. Yasushi Yagi (Osaka University), **"The OU-ISIR continuous authentication database comprising face and speech biometrics"**
- IS-1-155: Chi Xu (Osaka University)*; Xiang Li (Osaka University); Allam Shehata (Osaka University, Japan; Electronics Research Institute, Egypt); Prof. Yasushi Yagi (Osaka University), **"The OU-ISIR Multimodal Biometric Database and Its Performance Evaluation"**
- IS-1-156: Kaede Shintani (Osaka University)*; Xiang Li (Osaka University); Chi Xu (Osaka University); Prof. Yasushi Yagi (Osaka University), **"Correlation Analysis among Face, Voice, Body, and Palm Vein Biometrics Toward Cross-modal Biometric Authentication"**
...
- IS-1-161: Atsuki Sato (The University of Tokyo)*; Yusuke Matsui (The University of Tokyo), **"PCF Learned Sort: O(nloglogn)の期待計算量を持つ学習型ソートアルゴリズム (PCF Learned Sort: a Learning Augmented Sort Algorithm with O(nloglogn) Expected Complexity)"**
- IS-1-162: Kazuhiko Murasaki (NTT Corporation)*; Ryuichi Tanida (NTT Corporation), **"深度画像高解像度化のための位置ずれを考慮したGuided Filter (Misalignment-aware guided filter for depth image densification)"**
- IS-1-163: Wataru Ikeda (Keio University)*; Mariko Isogawa (Keio University), **"D-EventEgo: 動的環境における一人称視点イベントカメラを活用した三次元人物姿勢推定 (D-EventEgo: Event-based Egocentric 3D Pose Estimation with Dynamic Scene)"**
- IS-1-164: Yuki Tajima (Meisei University)*; Yuya Komatsu (Meisei University); Ryo Muto (Meisei University); Kazuya Ueki (Meisei University), **"スポーツ動作の骨格推定とユーモア動画生成への応用 (Sports Movement Pose Estimation and Its Application to Humorous Video Generation)"**
...
- IS-1-170: Xiangbo Kong (Toyama Prefectural University)*; Ken'ichi Koyanagi (	Toyama Prefectural University), **"Detection of Incorrect Knee Torsion in Karate Low Kick Using Azure Kinect"**
- IS-1-171: Ami Oozono (Kochi University of Technology)*; Toru Kurihara (Kochi University of Technology), **"4ch入力Mask R-CNNによる可視・熱画像と気温を使用した緑色果実の検出 (Detection of green fruits using visible and thermal imaging and temperature by 4ch input Mask R-CNN)"**
...
- IS-1-181: Pinwen WANG (Ritsumeikan University)*; Xiangbo Kong (Toyama Prefectural University); Norikazu Hayashi (NEXTY Electronics Corporation); Mei Jiang (NEXTY Electronics Corporation); Noriyoshi Kiuchi (NEXTY Electronics Corporation); Hiroyuki Tomiyama (Ritsumeikan University), **"Creation of 3D Indoor Maps of a University Hall with Tablet LiDAR for Drone Flight Simulation"**
- IS-1-182: Jeonghun Baek (The University of Tokyo)*; Yusuke Matsui (The University of Tokyo); Kiyoharu Aizawa (The University of Tokyo), **"Cross-Lingual Learning in Multilingual Scene Text Recognition"**
...
- IS-1-185: Ayu Shigeta (Wakayama University)*; 敏之 天野 (和歌山大学), **"プロジェクタカメラ系を用いた有彩色照明による色移りの色彩補償 (Color Compensation for Color Bleeding Caused by Chromatic Illumination Using a Projector-Camera System)"**
...
- OS-2A-06: Mana Masuda (Keio University)*; Jinhyung Park (Carnegie Mellon University); Shun Iwase (Carnegie Mellon University); Rawal Khirodkar (Meta); Kris Kitani (Carnegie Mellon University), **"Generalizable Neural Human Renderer"**
- OS-2A-07: Tomoya Sakai (IBM Research - Tokyo)*; haoxiang qiu (IBM); Takayuki Katsuki (IBM Research - Tokyo); Daiki Kimura (IBM Research); Takayuki Osogami (IBM Research - Tokyo); Tadanobu Inoue (IBM Research), **"Simple Class Relation Helps Generalized Few-Shot Semantic Segmentation"**
...
- OS-2B-04: Hiromasa Yamanishi (The University of Tokyo)*; Toshihiko Yamasaki (The University of Tokyo), **"LLaVATour: 日本語観光データに特化した大規模マルチモーダルモデルの作成 (LLaVA-Tour: Large Language and Vision Assistant for Japanese Tourism)"**
- OS-2B-05: 趙在瀛, 熊野創一郎, 山崎俊彦 (東大), **"Vision-Languageモデルを利用した画像分類におけるバイアスの言語的抽出と緩和"**
- OS-2B-06: Yuta Fujimoto (Nara Institute of Science and Technology)*; Kazuya Kitano (Nara Institute of Science and Technology); Yuki Fujimura (Nara Institute of Science and Technology); Takuya Funatomi (Nara Institute of Science and Technology); Yasuhiro Mukaigawa (NAIST), **"岩石薄片を用いた不均一分光フィルタによるワンショット分光撮像 (Petrographic Thin Plate Based Non-Uniform Spectral Filter for One-Shot Hyperspectral Imaging)"**
- OS-2B-07: Jiro Abe (NEC Corporation)*; Gaku Nakano (NEC Corporation), **"形状特徴量のレンダリングを活用したテクスチャレスな三次元点群に対するカメラ位置姿勢推定 (Visual localization on textureless point cloud by rendering geometric features)"**
...
- OS-2C-05: Masashi Suzuki (Chubu University)*; Tsubasa Hirakawa (Chubu University); Takayoshi Yamashita (Chubu University); Hironobu Fujiyoshi (Chubu Univ.); Komei Sugiura (Keio University), **"Reactive BiasのチューニングによるViTへの人の知見の組み込み (Reactive Bias to embed human knowledge in ViT through tuning)"**
- OS-2C-06: 小栗悠太郎, 松井勇佑 (東大), **"グラフベース近似最近傍探索における適応的開始点選択の理論的・実証的解析"**
- OS-2C-07: Weng Ian Chan (Osaka University)*; Hiroaki Santo (Osaka University); Yasuyuki Matsushita (Osaka University); Fumio Okura (Osaka University), **"Instance-wise Distribution Control of Text-to-image Diffusion Models"**
...
- OS-2D-07: Shunta Kimura (Tokyo University of Science)*; Kodai Kawamura (Tokyo University of Science); Shunya Yamagami (Tokyo University of Science); Qing Yu (The University of Tokyo); Kiyoharu Aizawa (The University of Tokyo); Go Irie (Tokyo University of Science), **"One-shot Test-Time Adaptation with Textual Inversion"**
- OS-2D-08: 篠田理沙 (京大), 塩原楓 (東大), **"動物の顔認識に対する大規模データセット構築"**
- OS-2D-09: Yohanssen Pratama (Nara Institute of Science and Technology)*; Kazuya Kitano (Nara Institute of Science and Technology); Takahiro Kushida (Ritsumeikan University); Yuki Fujimura (Nara Institute of Science and Technology); Takuya Funatomi (Nara Institute of Science and Technology); Yasuhiro Mukaigawa (NAIST), **"Pixel-Wise Material Classification Using Deep Learning by Utilizing Transient Responses"**
- OS-2D-10: Futa Kai Waseda (The University of Tokyo)*; Antonio Tejero-de-Pablos (CyberAgent), **"How to Defend Image-Text Retrieval against Adversarial Attacks (How to Defend Image-Text Matching Tasks against Adversarial Attacks)"**
...
- IS-2-004: Dixin Yang (Keio University)*; Mariko Isogawa (Keio University), **"Efficient Circular and Confocal Non-line-of-sight Imaging with transient sinogram Super Resolution"**
- IS-2-005: 熊谷涼平, 上田宇起, 平尾寿希, 川原僚 (九工大), 岡部孝弘 (岡山大), **"照明スペクトルと領域分割処理の同時学習によるワンショット蛍光物質検出"**
- IS-2-006: Kizuku Miyazawa (Nagoya Institute of Technology); Fumihiko Sakaue (Nagoya Institute of Technology)*; Jun Sato (Nagoya Institute of Technology), **"高速DLPプロジェクタと焦点距離可変レンズを利用したトモグラフィックディスプレイによる3次元画像提示 (Tomographic Display by Using DLP Projector and Focus Tunable Lens)"**
- IS-2-007: 岡本流星 (千葉大), 山下聖悟, 加藤卓哉 (エクサウィザーズ), 久保尋之 (千葉大), **"セルロースナノファイバーの偏光特性を用いた流れ場の可視化"**
- IS-2-008: Kazuma Fujiwara (Nara Institute of Science and Technology)*; Takuya Funatomi (Nara Institute of Science and Technology); Kazuya Kitano (Nara Institute of Science and Technology); Yuki Fujimura (Nara Institute of Science and Technology); Yasuhiro Mukaigawa (NAIST); Hiroshi Ochiai (Kyushu University), **"Quantification of Overlapped Fluorescent Dyes via an Autoencoder with Simultaneous Optimization of LCVR Voltage Selector and Quantifier"**
...
- IS-2-012: Carlos Victorino Padeiro (Nagoya University)*; Tse-Wei Chen (Canon Inc.); Takahiro Komamizu (Nagoya University); Ichiro Ide (Nagoya University), **"Leveraging Similarity-Preserving Post-Training Quantization for Lightweight Crop Disease Detection"**
...
- IS-2-019: Kosuke Arita (Canon Medical Systems Corporation)*; Yudai Yamazaki (Canon Medical Systems Corporation); Minoru Nakatsugawa (Canon Medical Systems Corporation), **"距離学習と最適輸送の融合によるモデル誤差に頑健な皮膚内部成分定量化手法 (Robust Quantification Method for Skin Internal Components via Metric Learning and Optimal Transport against Model Error)"**
- IS-2-020: 三好優輝, 川原僚 (九工大), 岡部孝弘 (岡山大), **"全方位偏光照明環境における実物体の光沢の操作"**
- IS-2-021: Masakatsu Aoki (NTT )*; Kazuya Yokohari (NTT); Ryuichi Tanida (NTT Corporation), **"複数LiDAR計測環境におけるキャリブレーション作業の一検討 (A Study of Extrinsic Calibration Work in Multipule LiDAR Measurement Environments)"**
- IS-2-022: ZHENNAN WU (The University of Tokyo)*; Hiroyuki Sato (The University of Tokyo), **"VoronoiTex: A Camera Position Sampling Strategy for Indoor Scene Texture Synthesis"**
...
- IS-2-026: Xiangjie Li (The University of Tokyo)*; Shuxiang Xie (University of Tokyo); Ken Sakurada (Kyoto University); Ryusuke Sagawa ("AIST, Japan"); Takeshi Oishi (The University of Tokyo), **"ニューラル表現を用いた可視－遠赤外線センサ融合による不可視シーンの3次元再構成 (Implicit Neural Fusion of RGB and Far-Infrared 3D Imagery for Invisible Scenes)"**
- IS-2-027: 幸壬晃 (滋賀大), 薗頭元春 (理研), 飯山将晃 (滋賀大), 川西康友 (理研), **"破滅的忘却抑制を考慮したカメラポーズ選択によるPanoptic Liftingの増分学習"**
- IS-2-028: Kai Katsumata (The University of Tokyo)*; Shengze Zhong (CyberAgent); Takafumi Taketomi (CyberAgent), **"不確実性推定付き3D Gaussian Splattingによる限られた観測からの新視点画像合成 (Novel View Synthesis from Limited Observations via 3D Gaussian Splatting with Uncertainty Estimates)"**
...
- IS-2-032: Qianwen Lu (CyberAgent)*; Xingchao Yang (Cyberagent, Inc); Takafumi Taketomi (CyberAgent), **"SynthMakeup: A Large-Scale Photo-Realistic Synthetic Makeup Dataset"**
...
- IS-2-035: Sai Htaung Kham (ZOZO Research)*; Kazuya Morishita (ZOZO Research); Yuki Hirakawa (ZOZO Research); Takashi Wada (ZOZO Research); Takuma Nakamura (BuySell Technologies Co., Ltd.); Yuki Saito (ZOZO Research), **"The Niau Dataset: A Comprehensive Resource for Fashion Image Recognition"**
- IS-2-036: Hideki Tsunashima (Waseda University)*; Yixin Zhu (Peking University); Shigeo Morishima (Waseda Research Institute for Science and Engineering), **"部分観測マルコフ決定過程下における系統的汎化ベンチマークの検討 (Considering A New Systematic Generalization Benchmark on POMDP)"**
- IS-2-037: Reo Terauchi (Tokyo Institute of Technology)*; Rei Kawakami (Tokyo Institute of Technology); Ikuro Sato (Tokyo Institute of Technology / Denso IT Laboratory), **"汎化改善のためのモデル診断 (Model Diagnostics for Improving Generalization)"**
- IS-2-038: Emika Kurita (Keio University)*; Tomoya Oyama (Keio University); Shuitsu Koyama (Keio University); Mariko Isogawa (Keio University), **"演奏音復元のための手書き邦楽譜文字認識 (Handwritten Japanese Traditional musical score character recognition for restoring performance sounds)"**
- IS-2-039: Ruka Murai (student)*; Yu Wang (Hitotsubashi University); Jiaqing Liu (ritsumeikan); Jien Kato (Kochi University of Technology), **"監視カメラを用いた酔客推定 (Drunk Pedestrian Recognition using Surveillance Camera)"**
- IS-2-040: 村上尚生, 平松直人, 小林大起, 秋月秀一, 橋本学 (中京大), **"固有空間における自然なデータ拡張に基づく外観検査の高精度化"**
- IS-2-041: Kensuke Tatematsu (waseda university)*; Hideki Tsunashima (Waseda University); Shigeo Morishima (Waseda Research Institute for Science and Engineering), **"World Model SEED: Semantic Exploration via Expert Demonstration for Improving Sample Eﬀiciency"**
- IS-2-042: Taku Fujitomi (NEC Corporation)*; Naoya Sogi (NEC Corporation); Takashi Shibata (NEC Corporation); Makoto Terao (NEC Corporation), **"未来予測の最終状態を用いたロボット制御計画の成否識別 (Success or Failure Classification for Robot Control Planning using Final State of Future Prediction)"**
- IS-2-043: Hidenori Itaya (Chubu university)*; Tsubasa Hirakawa (Chubu University); Takayoshi Yamashita (Chubu University); Hironobu Fujiyoshi (Chubu Univ.); Komei Sugiura (Keio University), **"Action Q-Transformerによる説明可能な強化学習 (Explainable Reinforcement Learning with Action Q-Transformer)"**
- IS-2-044: Tsunehiko Tanaka (Waseda University)*; Edgar Simo-Serra (Waseda University), **"Object-Oriented Embeddings for Offline RL using Unsupervised Object Detection"**
...
- IS-2-046: Kota Yamashita (Meijo University)*; Kazuhiro Hotta (Meijo University), **"Domain GeneralizationのためのMixStyle-based Contrastive Test-time Adaptation (MixStyle-Based Contrastive Test-Time Adaptation for Domain Generalization)"**
...
- IS-2-050: Yuki Kotoyori (Tokyo University of Science); Yuta Goto (Tokyo University of Science)*; Takashi Shibata (NEC Corporation); Akisato Kimura (NTT Corporation); Go Irie (Tokyo University of Science), **"記憶制御コードの最適化による選択的忘却 (Selective Forgetting with Mnemonic Code Optimization)"**
- IS-2-051: Ryo Karakida (National Institute of Advanced Industrial Science and Technology); Toshihiro Ota (CyberAgent, Inc.)*; Masato Taki (Rikkyo University), **"Symmetry breaking in parallelized MLP-Mixer"**
- IS-2-052: Takayuki Kanai (Toyota Motor Corporation)*; Igor Vasiljevic (Toyota Research Institute); Vitor Guizilini (Toyota Research Institute); Kazuhiro Shintani (Toyota Motor Corporation), **"A Study of the Initialization Effect of Learning-based SLAM with Dense Bundle Adjustment"**
- IS-2-053: 加太将弘, 吉橋亮太, 川上玲 (東工大), 池畑諭 (東工大, NII), 佐藤育郎 (東工大, デンソーアイティーラボラトリ), **"摂動に対するスパース混合エキスパートモデルの頑健化"**
- IS-2-054: Xinyu Li (Waseda University)*; Sei-ichiro Kamata (Waseda University), **"Quality-Aware Glaucoma Diagnosis Using Diffusion Models with Fundus Structural Feature Integration"**
...
- IS-2-058: Keisuke Kato (Sanei Hytechs Co., Ltd.)*; Bunta Furukawa (Sanei Hytechs Co., Ltd.); Masao Yamanaka (Toyota Motor Corporation), **"AIモデル開発における疑似ラベルを用いた認識能力の拡張 (Expanding Recognition Capability of AI Model via Pseudo-Labels)"**
- IS-2-059: Hideaki Hayashi (Osaka University)*, **"誤差逆伝播法を使用しない深層生成モデル (A Deep Generative Model without Backpropagation)"**
- IS-2-060: 持田海音, 中西慶一, 徳永旭将 (九工大), **"欠損補完に基づく画像異常検知に対してマスクの色が与える影響の評価"**
- IS-2-061: WENQI ZHANG (Sophia University)*, **"Improving Feature Extraction in GeoTransformer for Point Cloud Registration"**
- IS-2-062: Nagisa Koyama (Chubu University)*; Tsubasa Hirakawa (Chubu University); Takayoshi Yamashita (Chubu University); Hironobu Fujiyoshi (Chubu Univ.), **"複数の点群データセットを用いたSelf-trainingによる3D物体検出の教師なしドメイン適応 (Unsupervised Domain Adaptation on 3D Object Detection Using Self-training with Multiple Point Cloud Datasets)"**
- IS-2-063: Yuma Tanimoto (The University of Tokyo)*; Tetsuya Kobayashi (The University of Tokyo); Atsushi Kamimura (The University of Tokyo), **"深層生成隠れマルコフモデルの安定した学習手法の提案 (A stable learning method for deep generative hidden Markov models.)"**
...
- IS-2-067: Ren Togo (Hokkaido University)*; Nao Nakagawa (Hokkaido University); Takahiro Ogawa (Hokkaido University); Miki Haseyama (Hokkaido University), **"Exponential Dissimilarity-Dispersion Family for VAE-based Domain-Specific Representation Learning"**
- IS-2-068: 福永玲央, 吉田壮, 棟安実治 (関西大), **"対照学習を用いた類似クラス間の特徴量分離によるノイジーラベルに対する頑健性の向上"**
- IS-2-069: Naoto Hayashi (Chubu University)*; Tsubasa Hirakawa (Chubu University); Takayoshi Yamashita (Chubu University); Hironobu Fujiyoshi (Chubu Univ.); Yasunori Ishii (Panasonic Holdings); Yusuke Kato (Panasonic); Kazuki Kozuka (Panasonic Holdings Corporation), **"多様性と学習不足を考慮したデータ選択による自己教師あり継続学習 (Data Selection Considering Diversity and Underfitting for Self-Supervised Continual Learning)"**
- IS-2-070: Antonio Tejero-de-Pablos (CyberAgent)*; Riku Togashi (CyberAgent, Inc., Waseda University); Mayu Otani (CyberAgent); Shin'ichi Satoh (National Institute of Informatics), **"Source-Free Domain Adaptation with Class Distribution Shift via Generic Features"**
- IS-2-071: Yu Mitsuzumi (NTT Corporation / Kyoto University)*; Akisato Kimura (NTT Corporation); Hisashi Kashima (Kyoto University), **"Understanding and Improving Source-free Domain Adaptation from a Theoretical Perspective"**
- IS-2-072: Takashi Nishimoto (OMRON Corporation)*; Masanori Hashizaki (OMRON Corporation); Koichi Kinoshita (OMRON Corporation), **"良品特徴分布に基づく領域分割による少数ショット異常検出 (Few-shot Anomaly Detection via Area Separation Based on the Distribution of Normal Features)"**
...
- IS-2-088: Kanon Sato (Keio University)*; Takuya Nakabayashi (Keio University); Masahiro Yamaguchi (NEC Corporation); Kyota Higa (NEC Corporation); Ryo Fujiwara (NEC Corporation); Hideo Saito (Keio University), **"イベントカメラによるスポーツ競技のボール軌跡推定 (Ball Trajectory Estimation in Sports Using Event Cameras)"**
...
- IS-2-092: Zhaoyi An (Tokyo Institute of Technology); Rei Kawakami (Tokyo Institute of Technology)*, **"Generating Sign Language Poses with Pretrained Large Language Model"**
...
- IS-2-097: Megumi Kobayashi (ZOZO, Inc.)*; Ippei Yoshimoto (ZOZO, Inc.); Tomoya Kose (ex-ZOZO, Inc.), **"Moon & Spencer のAesthetic Measureを用いたファッションのカラー・コーディネート評価の検討 (The Moon-Spencer Aesthetic Measure for color harmony in fashion)"**
- IS-2-098: Naoya Nakajima (LY Corporation)*; Yuchi Ishikawa (LY Corporation); Masayoshi Kondo (LY Corp.), **"動画クラスタリングのためのDINOの動画への拡張の検討 (Exploring the Extension of DINO for Video Clustering)"**
- IS-2-099: Itthisak Phueaksri (Nagoya University)*; Marc A. Kastner (Hiroshima City University); Yasutomo Kawanishi (RIKEN); Takahiro Komamizu (Nagoya University); Ichiro Ide (Nagoya University), **"Toward Visual Storytelling using Scene-Graph Contexts"**
- IS-2-100: Haruto Izumi (Kumamoto University)*; Masahiro Migita (Kumamoto University); Masashi Toda (Kumamoto University); Masahiko Itoh (Kumamoto University), **"深層学習による画像インペインティングを用いた古文書画像中における紙背文書の復元 (Restoration of "Shihai-monjyo" in ancient document images using image inpainting with deep learning)"**
- IS-2-101: Takumi Katagiri (Tokyo University of Science)*; Yota Yamamoto (Tokyo University of Science); Go Irie (Tokyo University of Science); Yoko Sogabe ( NTT Corporation); Ayumi Matsumoto (NTT Corporation); Masaki Kitahara (NTT Corporation); Yukinobu Taniguchi (Tokyo University of Science), **"マルチスペクトル映像を用いた非接触酸素飽和度推定 (Non-contact oxygen saturation estimation using multispectral video)"**
- IS-2-102: Ryo Moriyama (Aoyama Gakuin University)*; Naoshi Kaneko (Tokyo Denki University); Kazuhiko Sumi (Aoyama Gakuin University), **"異常範囲の指定可能なAction Promptによる再学習不要の異常行動検知 (Anomaly Detection without re-learning based on Action Prompt specifying the range of anomaly)"**
...
- IS-2-107: Noriyuki Abe (TOPPAN Digital Inc.)*; Shuji Sakai (TOPPAN Digital Inc.), **"Latent Diffusion Modelsに基づくコミック着色 (Comic Colorization based on Latent Diffusion Models)"**
- IS-2-108: 早川恭平 (東工大), DongHyun Hwang (NAVER Cloud), Chen-Chieh Liao, 小池英樹 (東工大), **"拡散モデルを用いた一人称三次元姿勢推定の学習データ生成"**
- IS-2-109: Yudai Gondo (National Institute of Technology, Kurume College)*, **"Improving sparsity of Convolutional Sparse Representation using a combination of a few dictionary filters"**
- IS-2-110: 福田有輝也 (九工大), 下田和, 山口光太 (サイバーエージェント), **"Polygonによるテキストレイアウト制約に基づく画像生成"**
- IS-2-111: Jan Zdenek (CyberAgent)*; Wataru Shimoda (CyberAgent.Inc); Kota Yamaguchi (CyberAgent), **"Erasing Scene Text with Foundation Models"**
...
- OS-2D-09: Yohanssen Pratama (Nara Institute of Science and Technology)*; Kazuya Kitano (Nara Institute of Science and Technology); Takahiro Kushida (Ritsumeikan University); Yuki Fujimura (Nara Institute of Science and Technology); Takuya Funatomi (Nara Institute of Science and Technology); Yasuhiro Mukaigawa (NAIST), **"Pixel-Wise Material Classification Using Deep Learning by Utilizing Transient Responses"**
- OS-2D-10: Futa Kai Waseda (The University of Tokyo)*; Antonio Tejero-de-Pablos (CyberAgent), **"How to Defend Image-Text Retrieval against Adversarial Attacks (How to Defend Image-Text Matching Tasks against Adversarial Attacks)"**
- IS-2-116: Yusuke Oumi (Keio University)*; YUTO SHIBATA (Keio university); Go Irie (Tokyo University of Science); Akisato Kimura (NTT Corporation); Yoshimitsu Aoki (Keio University); Mariko Isogawa (Keio University), **"計測対象人物位置に頑健な音響情報を用いた三次元人物姿勢推定 (Acoustic-based 3D human pose estimation which robust to human position)"**
- IS-2-117: Yaozong Gan (Hokkaido University)*; Guang Li (Hokkaido University); Ren Togo (Hokkaido University); Keisuke Maeda (Hokkaido University); Takahiro Ogawa (Hokkaido University); Miki Haseyama (Hokkaido University), **"Fine-grained Traffic Sign Recognition Via Cross-domain Few-shot In-context Learning"**
- IS-2-118: Ziwen Lan (Hokkaido University)*; Keisuke Maeda (Hokkaido University); Takahiro Ogawa (Hokkaido University); Miki Haseyama (Hokkaido University), **"Adversarial Attack Focused on Manipulating Semantic Information for Personalized Text-to-Image Diffusion Models"**
- IS-2-119: 坂野達郎, 武縄瑞基, Leslie Wöhler (東大), 池畑諭 (NII, 東工大, 東大), 相澤清晴 (東大), **"実世界360度映像とCityGMLを融合したバーチャル空間の構築"**
- IS-2-120: YINGXUAN LI (The University of Tokyo)*; Ryota Hinami (Mantra Inc.); Kiyoharu Aizawa (The University of Tokyo); Yusuke Matsui (The University of Tokyo), **"Zero-Shot Character Identification and Speaker Prediction in Comics via Iterative Multimodal Fusion"**
- IS-2-121: 七田亮, 藤後廉, 前田圭介, 小川貴弘, 長谷山美紀 (北大), **"深層距離学習に基づく画像記憶性スコアの制御機構を導入したテキストからの画像生成に関する検討"**
- IS-2-122: Kotaro Kikuchi (CyberAgent)*; Naoto Inoue (CyberAgent); Mayu Otani (CyberAgent); Edgar Simo-Serra (Waseda University); Kota Yamaguchi (CyberAgent), **"Multimodal Markup Language Models for Graphic Design Completion"**
- IS-2-123: 熊谷香織 (NTT), 清水隆史 (警察大学校), 高木基宏, 瀬下仁志 (NTT), **"実世界の環境情報と人物属性を考慮する行動シミュレーション手法の検討"**
- IS-2-124: Yusuke Marumo (Chiba University)*; Kazuhiko Kawamoto (Chiba University); Hiroshi Kera (Chiba University), **"Matching Non-Identical Objects"**
- IS-2-125: 征樹 金川 (筑波大学)*; 脩平 高畑 (藍野大学); 慧 寺山 (横浜市立大学); Yoshihiro Kuroda (University of Tsukuba); 直人 家永 (筑波大学), **"小児の特徴を考慮したデータ拡張による書字検出 (Spatially unbalanced handwriting detection)"**
- IS-2-126: Yusei Shintani (Kumamoto University)*; Gou Koutaki (Kumamoto University), **"ハッシュドテンプレート：特定物体認識のための高精度かつ高速な手法 (Hashed templates:Highly accurate and fast specific object recognition method)"**
- IS-2-127: 田村駿弥, 下西慶, 近藤一晃, 中村裕一 (京大), **"意図を考慮した組み立て作業者の手の遷移位置予測"**
- IS-2-128: 齋藤健太, 数藤恭子 (東邦大), **"物体候補領域の超解像に基づく低解像度小物体検出"**
- IS-2-129: Momoe Yamane (Keio University)*, **"Occlusion Free Mutli-Object Tracking With Multiple Camera"**
- IS-2-130: Soyoko Otsuki (Keio University)*; Umihiro Kamoto (Panasonic Connect Co., Ltd.); Takeshi Watanabe (Panasonic Connect Co., Ltd.); Takeshi Fujimatsu (Panasonic Connect Co., Ltd); Yoshimitsu Aoki (Keio University), **"点群を利用した弱教師あり映像異常検知 (Weakly Supervised Video Anomaly Detection Using Point Cloud)"**
- IS-2-131: Yudai Ishihara (Kyushu University, Japan); Kohei Inoue (Kyushu University, Japan); Kenji Hara (Kyushu University, Japan)*, **"Yin-Yangグリッドを用いた全天球スーパーピクセル分割 (360-Degree Image Superpixel Segmentation Using Yin-Yang Grid)"**
- IS-2-132: Atsuyuki Miyai (The University of Tokyo)*; Jingkang Yang (Nanyang Technological University); Jingyang Zhang (Duke University); Yifei Ming (University of Wisconsin-Madison); Qing Yu (The University of Tokyo); Go Irie (Tokyo University of Science); Yixuan Li (University of Wisconsin-Madison); Hai Li (Duke University); Ziwei Liu (Nanyang Technological University); Kiyoharu Aizawa (The University of Tokyo), **"Unsolvable Problem Detection: Towards Trustworthy Vision-Language Models (Exploring Unsolvable Problem Detection toward Reliable Vision Language Models)"**
- IS-2-133: Shogo Iwakata (Waseda university)*; Ryosuke Oshima (Waseda University); Hideki Tsunashima (Waseda University); Fumiya Matsuzawa (Tsukuba University); Yue Qiu (National Institute of Advanced Industrial Science and Technology (AIST)); Hirokatsu Kataoka (National Institute of Advanced Industrial Science and Technology (AIST)); Shigeo Morishima (Waseda Research Institute for Science and Engineering), **"A New Benchmark for 3D Visual Grounding using Robotic Viewpoints"**
- IS-2-134: Chihaya Matsuhira (Nagoya University)*; Marc A. Kastner (Hiroshima City University); Takahiro Komamizu (Nagoya University); Takatsugu Hirayama (University of Human Environments); Ichiro Ide (Nagoya University), **"語感の定量化に向けた画像に写る概念に対する視覚的印象の推定 (Estimating the visual impression of a concept for quantifying human perception of nonwords)"**
- IS-2-135: Taichi Nishimura (LY Corporation)*, **"Lighthouse: 再現可能で使いやすい動画区間検索のライブラリ (Lighthouse: An easy-to-use, reproducible library for video moment retrieval)"**
...
- IS-2-141: Ryo Fujii (Keio University)*; Ryo Hachiuma (NVIDIA); Hideo Saito (Keio University), **"CrowdMAC: Masked Crowd Density Completion for Robust Crowd Density Forecasting"**
- IS-2-142: 平岡翼, 原田翔太, 満上育久 (広島市大), **"歩容解析のためのNeRFを用いた歩行映像生成"**
- IS-2-143: 高市将吾 (阪大), 青木工太 (鳥取大), 西野 (林) 美都子, 西野邦彦, 八木康史 (阪大), **"薬剤耐性菌トモグラムからの粒子検出"**
- IS-2-144: Mohamad Ammar Alsherfawi Aljazaerly (Osaka University)*; Prof. Yasushi Yagi (Osaka University), **"Human Model-Guided View Morphing for Clothed Gait Silhouettes"**
- IS-2-145: 日向寺拓海, 帖地俊平, 小篠裕子 (東京電機大), **"RGB画像から再構築したHS画像を用いた生体認証システム"**
- IS-2-146: Yusuke Fujisaka (CyberAgent,Inc.)*, **"サイバーエージェントのメディアサービスにおけるマルチメディアコンテンツ健全化への取り組み (Works for Safeguarding Multimedia Contents on Media Services in CyberAgent)"**
- IS-2-147: Shuntaro Masuda (The University of Tokyo)*; Toshihiko Yamasaki (The University of Tokyo), **"Transformerおよびマルチモーダル特徴量を用いたSNSアカウントの人気の時系列予測 (Popularity Prediction of SNS Accounts using Transformer and Multimodal Features)"**
- IS-2-148: Kentaro Ogawa (LY Corporation)*; Kenshiro Ata (LY Corporation); Mariko Okugawa (LY Corporation); Akiko Kato (LY Corporation); Yuichiro Nishimaki (LY Corporation), **"CLIPスコアによるワーカー評価 (Worker Evaluation in Crowdsourcing Using CLIP Scores)"**
- IS-2-149: Yamato Okamoto (Naver Cloud Corp.)*; Youngmin Baek ( Clova AI Research, NAVER Corp.); Geewook Kim (NAVER Corporation); Ryota Nakao (LINE WORKS Corp.); DongHyun Kim (NAVER Cloud); Moonbin Yim (Clova AI Research, NAVER Corp.); Seunghyun Park (Naver Cloud AI); Bado Lee (Clova AI Research, NAVER Corp.), **"CREPE: Coordinate-Aware End-to-End Document Parser"**
- IS-2-150: 原口大地 (九大, サイバーエージェント), **"非言語依存なフォントスタイル変換へ向けて"**
- IS-2-151: Yamato Kurihara (Tokyo Denki University)*; Wataru Ohyama (Tokyo Denki University); Eisaku Maeda (Tokyo Denki University), **"ViT, CNNを利用したくずし字認識に関する一検討 (A Study on Kuzushiji Character Recognition Using ViT and CNN)"**
- IS-2-152: Nanami Kotani (The University of Tokyo)*; Yasuaki Monnai (The University of Tokyo), **"心拍信号に基づくロックイン・サーモグラフィによる微小な体温変化の計測 (Measurement of minute changes in body temperature using lock-in thermography based on heart rate signals)"**
...
- IS-2-156: Sota Oizumi (The University of Tokyo)*; Takuhiro Kaneko (NTT Corporation); Tatsuya Harada (The University of Tokyo / RIKEN), **"MIMIC: Motion Imitation Model via In-Context Learning with LLMs"**
- IS-2-157: 沼田椋太郎 (無所属), 堀涼介 (慶大), 福原吉博 (早大), 五十川麻理子 (慶大), **"ウェアラブルインソール型圧力センサを用いた人物の3次元姿勢推定"**
- IS-2-158: Taishu  Arashima (Chiba University)*; hayato yamamuro (kyocera); Yuki Tomigami (kyocera); Yashuhiro Fukui (kyocera); Kenji Kono (kyocera); Hiroshi Kera (Chiba University); Kazuhiko Kawamoto (Chiba University), **"一人称視点2次元骨格系列からの3次元人物軌跡予測 (Human Trajectory Prediction from first-person 2D skeletal series)"**
- IS-2-159: Hiroki Yazaki (Keio University)*; Ryosuke Hori (Keio University); Tomoya Matsubara (Keio University); Hideo Saito (Keio University), **"二人称視点カメラによる事前3D環境を活用した一人称視点動画の推定 (Estimation of First-Person View Videos Utilizing Prior 3D Environment Captured by Second-Person Cameras)"**
- IS-2-160: Takayuki Katsuki (IBM Research - Tokyo)*; haoxiang qiu (IBM); Tomoya Sakai (IBM Research - Tokyo); Takayuki Osogami (IBM Research - Tokyo); Tadanobu Inoue (IBM Research); Daiki Kimura (IBM Research); A. Cristiano I. Malossi (IBM Research - Zurich), **"Domain-adaptive Instance Segmentation for Visual Inspection from Civil Infrastructure Images"**
- IS-2-161: Tomohiro Suzuki (Nagoya University)*; Tanaka Ryota (Nagoya university); Kazuya Takeda (Nagoya University); Keisuke Fujii (Nagoya University / RIKEN), **"単眼3次元姿勢推定のスポーツ動作への教師なし最適化 (Unsupervised fine-tuning of the monocular 3D pose estimation model for sports motion)"**
- IS-2-162: Yukino Tsuzuki (Yachiyo Engineering Co.,Ltd.)*; Ryuto Yoshida (Yachiyo Engineering Co.,Ltd.); Junichi Okubo (Yachiyo Engineering Co.,Ltd.); Junichiro Fujii (Yachiyo Engineering Co.,Ltd.); Masahiro Okano (Yachiyo Engineering Co., Ltd.); Riku Ogata (Yachiyo Engineering Co.,Ltd.); Takayoshi Yamashita (Chubu University), **"Ensemble PatchCoreとSQ-VAEによる多段階異常検知 (Multi-step Anomaly Detection with Ensemble PatchCore and SQ-VAE)"**
...
- IS-2-165: Yuki Hirakawa (ZOZO Research)*; Kazuya Morishita (ZOZO Research); Takashi Wada (ZOZO Research); Ryotaro Shimizu (ZOZO Research); Takuya Furusawa (ZOZO Research); Sai Htaung Kham (ZOZO Research); Yuki Saito (ZOZO Research), **"大規模視覚言語モデルを用いた「似合う」の自動評価法 (Automatic Evaluation Method for Visual Compatibility using Large-scale Vision Language Models)"**
- IS-2-166: 山岸峻造, 謝淳 (筑波大), 宍戸英彦 (創価大), 北原格 (筑波大), **"パンチルトズーム映像による広範囲を移動する選手の位置推定手法"**
- IS-2-167: Hinako Mitsuoka (Meijo University)*; Kazuhiro Hotta (Meijo University), **"Feedback Formerを用いた細胞画像セグメンテーションの精度向上 (Accuracy Improvement of Cell Image Segmentation Using Feedback Former)"**
...
- IS-2-171: Ryo Fujii (Keio University)*; Hideo Saito (Keio University); Hiroki Kajita (Keio University), **"EgoSurgery: A Dataset for Surgical Video Understanding from Egocentric Open Surgery Videos ({EgoSurgery: A Dataset for Surgical Video Understanding from Egocentric Open Surgery Videos)"**
- IS-2-172: 矢野友理, 小森達貴, 西川広記, 谷口一徹, 尾上孝雄 (阪大), **"転移学習と前処理を用いた尿中有形成分の検出"**
- IS-2-173: Yu Yamaoka (Osaka University)*; Weng Ian Chan (Osaka University); Shigeto Seno (Osaka University); Hideo Matsuda (Osaka University), **"Weakly Supervised Learning from Similarity Proportion Loss for Classification in the Skeletal Muscle Recovery Process"**
- IS-2-174: 佐々木桂太, 西川広記, 谷口一徹, 尾上孝雄 (阪大), **"アンサンブル学習を用いた尿中有形成分の検出高精度化"**
- IS-2-175: Kenji Fujimoto (Hirosaki University)*; Shigeto Seno (Osaka University); Hironori Shigeta (Osaka University); Yutaka Uchida (Osaka University); Masaru Ishii (Osaka University); Yoshinori Tamada (Hirosaki University); Hideo Matsuda (Osaka University), **"経時観測蛍光画像における細胞同士の重畳を考慮した細胞追跡手法 (Overlap-Aware Cell Tracker for Time-Lapse Fluorescence Microscopy)"**
...
- IS-2-180: Shunta Matsumoto (Nagasaki university)*; Keita Takeda (Nagasaki University); Tomoya Sakai (Nagasaki University); Eiji Mitate (Kanazawa Medical University), **"回転同変な深層学習モデルは口腔細胞診に有効か？ (Experimental Verification of the Effectiveness of Equivariant Deep Learning Models for Oral Cytology)"**
- IS-2-181: 近藤涼太, 田崎豪 (名城大), **"異常検出を利用した整理対象物体の検出"**
- IS-2-182: 水野智貴, 矢橋和也, 田崎豪 (名城大), **"視点推定に基づくカメラアーム制御による物体姿勢推定精度の向上"**
- IS-2-183: Swe Nwe Nwe Htun (National Institute of Advanced Industrial Science and Technology)*; Shusaku  Egami (National Institute of Advanced Industrial Science and Technology); Takanori  Ugai (National Institute of Advanced Industrial Science and Technology; Fujitsu Limited); Yijun  Duan (National Institute of Advanced Industrial Science and Technology); Ken Fukuda (National Institute of Advanced Industrial Science and Technology), **"3D Spatial Grounding in Virtual Environments: A VirtualHome2KG Study"**
...
- OS-3A-03: Hodaka Kawachi (Osaka University)*; Tomoya Nakamura (Osaka University); Hajime Nagahara (Osaka University); Prof. Yasushi Yagi (Osaka University), **"符号化開口と拡散モデルを用いた単一ボケ画像からの深度再構成 (Single-Image Depth from Defocus with Coded Aperture and Diffusion Posterior Sampling)"**
- OS-3A-04: Masatoshi Tateno (Institute of Industrial Science, The University of Tokyo)*; Takuma Yagi (National Institute of Advanced Industrial Science and Technology (AIST)); Ryosuke Furuta (The University of Tokyo); Yoichi Sato (University of Tokyo), **"Learning Object States from Actions via Large Language Models"**
- OS-3A-05: YUTO SHIBATA (Keio university)*; Yasunori Kudo (Preferred Networks, Inc.); Yohei Sugawara (Preferred Networks, Inc.), **"Anatomical 3D Style Transfer Enables Efficient Federated Learning with Extremely Low Communication Costs"**
- OS-3A-06: 松尾信之介 (九大), 末廣大貴 (横浜市大), 計良宥志 (千葉大), 内田誠一, 備瀬竜馬 (九大), **"Prototypeに基づいたAttentionによるLearning from Label Proportions"**
- OS-3A-07: Kengo Ikeuchi (The University of Tokyo)*; Jiafeng Mao (The University of Tokyo); Qing Yu (The University of Tokyo); Go Irie (Tokyo University of Science); Kiyoharu Aizawa (The University of Tokyo), **"追加学習された拡散モデルに対するメンバーシップ推論 (Membership inference against fine-tuned diffusion models)"**
...
- IS-3-005: Tomoki Inoue (Nagoya University)*; Keita Takahashi (Nagoya University); Yuya Ishikawa (Nagoya University); Shuji Habuchi (Nagoya University); Chihiro Tsutake (Nagoya University); Toshiaki Fujii (Nagoya Univ.); Hajime Nagahara (Osaka University), **"自己教師型学習に基づく光線空間の符号化撮像 (Self-Supervised Approach to Coded Light-Field Acquisition)"**
- IS-3-006: Kenji Doi (LY Corporation)*; Shuntaro Okada (LY corporation); Ryota Yoshihashi (LY Corporation); Hirokatsu Kataoka (LY Cooperation), **"Real-SRGD: 分類器無しガイダンスによる実世界超解像向け拡散モデルの画像品質改善 (Real-SRGD: Enhancing Real-World Image Super-Resolution with Classifier-Free Guided Diffusion)"**
- IS-3-007: Suzan J Kessy (Nara Institute of Science and Technology)*; Takuya Funatomi (Nara Institute of Science and Technology); Kazuya Kitano (Nara Institute of Science and Technology); Yuki Fujimura (Nara Institute of Science and Technology); Takahiro Kushida (Ritsumeikan University); Guillaume Caron (Universite de Picardie Jules Verne); El Mustapha Mouaddib (Universite de Picardie Jules Verne); Yasuhiro Mukaigawa (NAIST), **"Mitigating Temporal Illumination Variation in Whisk-broom Hyperspectral Imaging using Dual-Perpendicular Scans"**
...
- IS-3-013: Ali Caglayan (National Institute of Advanced Industrial Science and Technologhy (AIST), Tokyo, Japan); Nevrez Imamoglu (AIST)*; Oguzhan Guclu (Ahi Evran University); Ali Osman Serhatoglu  (Hacettepe University); Ahmet Burak Can (Hacettepe University), **"Attention Guided Odometry: Enchancing RGB-D SLAM with Task-Specific Network Attention"**
- IS-3-014: Shengze Zhong (CyberAgent)*; Takafumi Taketomi (CyberAgent), **"Articulated Gaussian Splatting via GridShift"**
- IS-3-015: 上田栞, 斎藤英雄 (慶大), 森尚平 (グラーツ工科大), **"合成ぼけ画像評価を用いた多層画像生成法"**
- IS-3-016: Kota Shinjo (Toyota Motor Corporation)*; Takayuki Kanai (Toyota Motor Corporation); Yuto Mori (Toyota Motor Corporation), **"人体骨格推定を用いた単眼深度推定器のスケール復元 (Scale Recovery of Monocular Depth Estimator Using Human Pose Estimation)"**
- IS-3-017: Li Peizhao, 遠里由佳子 (立命館大), **"特徴点マッチングを用いた画像処理によるマウス脳形状の三次元モデルの構築"**
- IS-3-018: Kazuto Ichimaru (Fujitsu Defense & National Security, Ltd.)*; takaki ikeda (kyushu university); Diego Thomas (Kyushu University); Takafumi Iwaguchi (Kyushu Univ.); Hiroshi Kawasaki (Kyushu univ.), **"Neural Active Structure-from-Motion"**
...
- IS-3-021: Takuto Nishio (Nagoya University)*; Chihiro Tsutake (Nagoya University); Keita Takahashi (Nagoya University); Toshiaki Fujii (Nagoya Univ.), **"Warm-Start NeRF：NeRFに基づく光線空間の学習 における汎化型エンコーダを用いた高速化 (Warm-Start NeRF: Acceleration Using a Generalization Encoder in Learning Light Fields Based on NeRF)"**
- IS-3-022: Takeshi Endo (Hitachi, Ltd.)*, **"視差算出におけるマッチングコストの再考 (Rethinking Matching Cost in Disparity Estimation)"**
...
- IS-3-025: Kai Kohyama (Keio University)*; Shintaro Shiba (Keio University); Yoshimitsu Aoki (Keio University), **"イベントカメラによる三次元人体スキャンにおける三次元表現の検討 (A Study on Different 3D Representations for Event-based 3D Human Scan)"**
...
- IS-3-034: Yuiko Sakuma (Sony Group Corporation)*; Masakazu Yoshimura (Sony Group Corporation); Junji Otsuka (Sony Group Corporation); Atsushi Irie (Sony Group Corporation); Takeshi Ohashi (Sony Group Corporation), **"Mixed-precision Supernet Training from Vision Foundation Models using Low Rank Adapter"**
- IS-3-035: Ryota Higashi (Wakayama university)*; Toshikazu Wada (Wakayama University), **"Data Pruningにおける蒸留を用いた特徴空間の再構成 (Feature Space Reconstruction Using Knowledge Distillation in Data Pruning)"**
- IS-3-036: Ryosuke Imazu (Nagoya University)*; Chihiro Tsutake (Nagoya University); Keita Takahashi (Nagoya University); Toshiaki Fujii (Nagoya Univ.), **"Mono+Sub：単眼画像と付加情報による光線空間符号化 (Mono+Sub: Compressing Light Field as Monocular Image and Subsidiary Data)"**
...
- IS-3-041: Xinyue Li (Ritsumeikan University)*; Jiaqing Liu (ritsumeikan); Yu Wang (Hitotsubashi University); Jien Kato (Kochi University of Technology), **"Hypergraph-enhanced Spatio-Temporal Transformer for Nurse Activity Recognition"**
- IS-3-042: 古里和暉, 中西慶一, 徳永旭将 (九工大), **"欠損補完に基づく画像異常検知に対してマスクサイズが与える影響の評価"**
- IS-3-043: Taiki Sekii (Cyberagent)*, **"Flashback機構を用いたTransformersとMambaのメモリ効率化と高速化 (Memory Optimization and Acceleration of Transformers and Mamba via Flashback Mechanism)"**
- IS-3-044: 宮部大翔, 米田駿介, 井上路子, 西山正志 (鳥取大), **"線対称サンプルを含む場合のクラスタリングのためのLine-symmetrical Sample k-means++の提案"**
- IS-3-045: Hayate Masuda (The University of Tokyo)*; Hiroaki Shiokawa (University of Tsukuba); Yusuke Matsui (The University of Tokyo), **"グラフ最近傍探索のための再帰的部分グラフ量子化 (Recursive Subgraph Quantization for Approximate Nearest Neighbor Search)"**
...
- IS-3-049: Lang Huang (The University of Tokyo)*; Toshihiko Yamasaki (The University of Tokyo), **"Exploring Prediction Targets in Masked Image Modeling"**
- IS-3-050: Atsushi Katayama (NTT Corporation)*; Kazuhiko Murasaki (NTT Corporation); Ryuichi Tanida (NTT Corporation), **"スパイキングニューラルネットワークを用いた自動概念生成 (Automatic Concept Generation Using Spiking Neural Networks)"**
...
- IS-3-054: Chi Zhang (The University of Tokyo)*; Toshihiko Yamasaki (The University of Tokyo), **"TDiffCF: Trainable Diffusion Model for Collaborative Filtering"**
...
- IS-3-058: Mashiro Toyooka (The University of Tokyo)*; Atsuyuki Miyai (The University of Tokyo); Qing Yu (The University of Tokyo); Go Irie (Tokyo University of Science); Kiyoharu Aizawa (The University of Tokyo), **"ブラックボックス視覚言語モデルのためのFew-Shot教師なしプロンプト学習 (Few-Shot Unsupervised Prompt Learning for Black-Box Vision-Language Models)"**
- IS-3-059: koyo Imai (Chubu University)*; Naoto Hayashi (Chubu University); Tsubasa Hirakawa (Chubu University); Takayoshi Yamashita (Chubu University); Hironobu Fujiyoshi (Chubu Univ.), **"Contrastive Lossを導入したEMP-SSLによる自己教師ありオンライン継続学習 (Self-Supervised Online Continual Learning by EMP-SSL with Contrastive Loss)"**
- IS-3-060: Yuya Otsuka (LY Corporation)*; Ryota Yoshihashi (LY Corporation); Kenji Doi (LY Corporation); Tomohiro Tanaka (LY Corporation), **"拡散モデルを用いた意味領域分割のための擬似マスク生成における教師なしドメイン適応 (Unsupervised Domain Adaptation for Pseudo-Mask Generation in Semantic Segmentation Using Diffusion Models)"**
...
- IS-3-065: Yanan Wang (KDDI Research)*; Shuichiro Haruta (KDDI Research, Inc.); Donghua Zeng (KDDI Research); Mori Kurokawa (KDDI Research, Inc.), **"Multi-object event graph representation learning for Video Question Answering"**
- IS-3-066: Zhenzhen Quan (Shandong University)*; Jialei Chen (Nagoya University); Chenkai ZHANG (Nagoya University); Daisuke Deguchi (Nagoya University); Hiroshi Murase (Nagoya University), **"A Decoupled Knowledge Distillation Approach for RGB-to-Infrared Video Action Recognition"**
- IS-3-067: 鈴木真, 鷲見和彦 (青学大), **"追加ラベルとブランチ分割による行動予測の検討"**
- IS-3-068: 利重夏美, 陳訓泉, 岡部正幸 (県立広島大), 陳金輝 (和歌山大), **"SlowFastモデルを用いた転倒行動の認識"**
- IS-3-069: Yasufumi Kawano (Keio Univ.)*; Yoshimitsu Aoki (Keio University), **"MaskDiffusion: Exploiting Pre-trained Diffusion Models for Semantic Segmentation"**
...
- IT-15: Atsuyuki Miyai (Univ. of Tokyo), Qing Yu (LY, Univ. of Tokyo), Go Irie (Tokyo Univ. of Science), Kiyoharu Aizawa (Univ. of Tokyo), **"LoCoOp: Few-Shot Out-of-Distribution Detection via Prompt Learning"**, [NeurIPS]
- IT-16: Yuki Fujimura (NAIST), Masaaki Iiyama (Shiga Univ.), Takuya Funatomi, Yasuhiro Mukaigawa (NAIST), **"Deep Depth from Focal Stack with Defocus Model for Camera-Setting Invariance"**, [IJCV]
- IS-3-073: Takuya Tsujimura (osaka metropolitan university)*; Katsufumi Inoue (Osaka Metropolitan University); Michifumi Yoshioka (Osaka Metropolitan University); Toshihiro Yamada (Hokkaido University), **"スタイル変換とフラクタル画像を用いた植物化石検出手法の検討 (Examination of Method for Detecting Plant Fossils Using Style Transfer and Fractal Images)"**
- IS-3-074: Yuki Nishimura (TOSHIBA CORPORATION)*; Ryota Sekiya (TOSHIBA CORPORATION); Hiroki Mori (TOSHIBA CORPORATION), **"合成開口レーダ画像向けニューラルネットワークにおける​少量訓練データ対策の有効性検証 (Verification of the Effectiveness of Measures to Train Neural Network for Synthetic Aperture Radar Images by Limited Data)"**
- IS-3-075: 清水一樹, 遠里由佳子 (立命館大), **"潜在拡散モデルと自己注意ガイダンスによる線⾍の動画像の異常検知"**
- IS-3-076: Ryoya Nara (The University of Tokyo)*; Yu-Chieh Lin (Kioxia Corporation); Yuji Nozawa (Kioxia Corporation); Youyang Ng (Kioxia Corporation); Goh Itoh (Kioxia Corporation); Osamu Torii (Kioxia Corporation); Yusuke Matsui (The University of Tokyo), **"CLIPと適合性フィードバックによる対話的検索システム (Revisiting Relevance Feedback for CLIP-based Interactive Image Retrieval)"**
- IS-3-077: 昇洋太, 小篠裕子 (電機大), 田中正行 (東工大), **"ハイパースペクトル画像に基づくペンギンの個体識別"**
- IS-3-078: Lauri Klemettinen (Toyohashi University of Technology); Yuki Sato (Toyohashi University of Technology); Yasushi Kanazawa (Toyohashi University of Technology)*; Jun Sonoda (National Institute of Technology, Sendai College), **"Interpolation of Ground Penetrating Radar Images using Deep Latent Variable Models"**
- IS-3-079: Shota Nakada (LY Corporation)*; Taichi Nishimura (LY Corporation); Hokuto Munakata (LY Corporation); Tatsuya Komatsu (LY Corporation); Masayoshi Kondo (LY Corp.), **"音を発生させる物体を考慮した視聴覚表現学習 (Fine-grained Audio-Visual Representation Learning from Sounding Objects)"**
...
- IS-3-084: Jing YANG (UEC); Junwen Chen (The University of Electro-Communications); JINGBIN XU (The University of Electro-Communications); Keiji Yanai (The University of Electro-Communications, Tokyo)*, **"RecipeSD: Injecting Recipe Embedding into Food Image Synthesis using Stable Diffusion"**
- IS-3-085: 松雄なずな, 出口大輔, 村瀬洋 (名大), **"拡散モデルを用いた人物の後ろ姿からの正面服装画像生成"**
- IS-3-086: Ryota Kaji (The University of Electro-Communications)*; Keiji Yanai (The University of Electro-Communications, Tokyo), **"動画拡散モデルを用いた複数物体におけるゼロショット動作制御 (Zero-Shot Motion Control in Multiple Objects Using Video Diffusion Model)"**
- IS-3-087: Masakazu Yoshimura (Sony Group Corporation)*; Junji Otsuka (Sony Group Corporation); Takeshi Ohashi (Sony Group Corporation), **"PQDynamicISP: Dynamically Controlled Image Signal Processor for Any Image Sensors Pursuing Perceptual Quality"**
- IS-3-088: Yuki Kondo (Toyota Motor Corporation)*; Takayuki Kanai (Toyota Motor Corporation); Kota Shinjo (Toyota Motor Corporation); Ken Sakurada (Kyoto University), **"Beyond Image Stitching: 幾何的整合性を担保するFoV拡大タスク FoVE (Novel NVS task FoVE imposing geometric and luminance fidelity)"**
- IS-3-089: YI LIU (Graduate School of Information Science and Technology, OSAKA University )*; Sudhakar Kumawat (Osaka University); Hajime Nagahara (Osaka University), **"ハードウェアでモダリティ融合を用いた画像セグメンテーション (Deep Hardware Modality Fusion for Image Segmentation)"**
- IS-3-090: 工藤紗織, 鎌田清一郎 (早大), **"ハイパースペクトル画像超解像のためのスペクトル・グルーピングTransformer"**
- IS-3-091: Masato Ishii (Sony AI)*; Akio Hayakawa (Sony AI); Takashi Shibuya (Sony AI); Yuki Mitsufuji (Sony AI), **"A Simple but Strong Baseline for Sounding Video Generation"**
...
- IS-3-094: Daijiro Higashi (Meijo University)*; Kotaro Kurake (Meijo University); Tsuyoshi Tasaki (Meijo University), **"単眼カメラによる三次元地図を利用した動的障害物のスケール付き距離推定 (Monocular metric scale obstacle detection by using 3D-Map)"**
- IS-3-095: 渡邉拓海, 川上玲, 田中正行, 奥富正敏 (東工大), **"複数のトーンマッピングを利用したHDR画像のための物体検出手法"**
- IS-3-096: Taito Kato (National Institute of Technology, Sendai College); Jun Sonoda (National Institute of Technology, Sendai College)*, **"UAV空撮画像とYOLOv8による背景分類を適用した海岸漂着物の自動検出 (Automatic Detection of Beach Debris by Applying UAV Aerial Imagery and YOLOv8 Background Classification)"**
...
- IS-3-100: Takuya Nanri (Nissan Motor Co., Ltd.)*; Siyuan Wang (Nissan Motor Co., Ltd.); Akio Shigekane (Nissan Motor Co., Ltd.); jo nishiyama (NISSAN MOTOR CO.,LTD.); Tao Chu (Nissan Motor Co., Ltd.); Kohei Yokosawa (Nissan Motor Co., Ltd.), **"大規模マルチモーダルモデルを用いた自動運転のための将来軌道説明の検討 (Trim-Former: Trajectory Explanation using Multi-modal Large Language Model for Autonomous Driving)"**
...
- IS-3-104: Teppei Suzuki (SB Intuitions)*; Seitaro Shinagawa (Nara Institute of Science and Technology), **"Instructable Image Encoding"**
- IS-3-105: 宮脇智也, 中嶋一斗, 劉瀟文 (九大), 岩下友美 (JPL), 倉爪亮 (九大), **"拡散モデルの条件付き生成を用いたLiDARデータのSim2Realドメイン変換"**
- IS-3-106: Zhang Run Shi (Osaka University)*; Xiang Li (Osaka University); Chi Xu (Osaka University); Prof. Yasushi Yagi (Osaka University), **"Multi-View Large Population Gait Database with Point Clouds and Its Performance Evaluation for LiDAR-based Gait Recognition"**
...
- IS-3-109: Julian Jorge Andrade Guerreiro (The University of Tokyo)*; Naoto Inoue (CyberAgent); Kento Masui (CyberAgent); Mayu Otani (CyberAgent); Hideki Nakayama (The University of Tokyo), **"Exploring Flow Matching for Layout Generation"**
- IS-3-110: Keigo Kunikata (Tokyo University of Science)*; Amane Kashino (Tokyo University of Science); Yota Yamamoto (Tokyo University of Science); Yukinobu Taniguchi (Tokyo University of Science); Yoko Sogabe ( NTT Corporation); Ayumi Matsumoto (NTT Corporation); Masaki Kitahara (NTT Corporation); Go Irie (Tokyo University of Science), **"Person Identification from Hyperspectral Hand Images"**
- IS-3-111: Tatsuki Arai (Keio University)*; Mariko Isogawa (Keio University); Kuniharu Sakurada (Keio University); Maki Sugimoto (Keio University), **"超低解像度熱画像を用いた三次元人物姿勢推定 (3D Human Pose Estimation Using Thermal Images Considering Ambient Temperature)"**
- IS-3-112: Yuki Era (Hokkaido University)*; Ren Togo (Hokkaido University); Keisuke Maeda (Hokkaido University); Takahiro Ogawa (Hokkaido University); Miki Haseyama (Hokkaido University), **"Metadata-independent Learning and Unified Dataset for Generalized Motion Generation Method"**
- IS-3-113: 和田智輝, 伊藤康一, 青木孝文 (東北大), **"撮影環境の変動に頑健な動画像からの手の3次元姿勢推定手法の検討"**
- IS-3-114: 鳥見晃平, 青木義満 (慶大), **"ゴルフスイング解析における追加関節点を考慮した2次元姿勢推定"**
- IS-3-115: Matthew Teng Kit Khinn (Kyushu Institute of Technology)*; Haibo Zhang (Kyushu Institute of Technology); Takeshi Saitoh (Kyushu Institute of Technology), **"Exploring Motion History Images with LGNMNet-RF for Micro-Expression Spotting"**
- IS-3-116: 佐藤光希, 荒金大清, 張海波, 齊藤剛史 (九工大), **"生成モデルによる発話シーンを利用した日本語文章読唇"**
- IS-3-117: Akos Godo (Osaka University)*, **"PPGCN: Phase-aligned Periodic Graph Convolutional Network for Dual-task-based Cognitive Impairment Detection"**
...
- IS-3-121: Chiyun Li (The University of Tokyo)*; Yilin Wen (The University of Tokyo); Yusuke Sugano (The University of Tokyo), **"A Preliminary Study on Face Anonymization in Gaze Estimation"**
...
- IS-3-124: Ryoga Takahashi (Tokyo University of Science)*; Yota Yamamoto (Tokyo University of Science); Ryosuke Furuta (The University of Tokyo); Yukinobu Taniguchi (Tokyo University of Science), **"高速カメラの動画解析を用いたドア閉じ異常検知 (Detection of Door Closing Defects by Analyzing Video from a High-speed Camera)"**
- IS-3-125: 森川元晴, 前田英作 (東京電機大), **"工業製品の異常検知における事前学習効果の検討"**
- IS-3-126: Naoki Yoshida (DAIKIN INDUSTRIES, LTD.)*; Taiho Takeuchi (Fairy Devices Inc.); Takuya Ohara (DAIKIN INDUSTRIES, LTD.); Tomohiro Mito (Fairy Devices Inc.); Yoshinao Sato (Fairy Devices Inc.); Yoshifumi Seki (Fairy Devices Inc.); Shohei Hido (DAIKIN INDUSTRIES, LTD.), **"一人称視点映像の作業認識と自己教師あり学習の試み (Task Recognition and Self-Supervised Learning from First-Person View Videos)"**
- IS-3-127: 西川由馬, 坂本大地, 坂上文彦, 佐藤淳 (名工大), **"繊維製品の画像検査のための異常判別器と照明条件の同時最適化"**
- IS-3-128: Daichi Tanaka (Tokyo Institute of Technology)*; Takumi Karasawa (Tokyo Institute of Technology); Rei Kawakami (Tokyo Institute of Technology), **"鉄スクラップのリサイクルのための生成モデルを活用したテキストと画像の少数例示による異常の領域分割 (Few-shot Anomaly Detection Utilizing A Generative Model for Scrap Metal Recycling)"**
...
- IS-3-135: Azuma Miura (Keio University)*; Hideo Saito (Keio University), **"自動マスクプロンプト作成とEfficientViTによるSAMの改良 (Automatic High-Quality Mask Prompt Generation for SAM Enhancement in Endoscopic Videos Using EfficientViT)"**
- IS-3-136: Roma Satoh (Tokyo Institute of Technology)*; Nakamasa Inoue (Tokyo Institute of Technology); Rei Kawakami (Tokyo Institute of Technology), **"ロボットによる物体再配置の予測における隆起関数を用いた衝突回避 (Collision Avoidance in Object Relocation by Robots Using Bump Functions)"**
- IS-3-137: Daichi Azuma (Sony Semiconductor Solutions)*; Taiki Miyanishi (The University of Tokyo); Shuhei Kurita (RIKEN AIP); Koya Sakamoto (Kyoto University); Motoaki Kawanabe (Advanced Telecommunications Research Institute International (ATR)), **"実世界質問応答のための拡散モデルを用いた回答可能位置の予測 (Answerability Fields: Answerable Location Estimation via Diffusion Models)"**
- IS-3-138: Jeonghun Baek (The University of Tokyo)*; Yusuke Matsui (The University of Tokyo); Kiyoharu Aizawa (The University of Tokyo), **"Character Combination for Low-Resource Text Recognition (Character Combination for Scene Text Recognition with Low-Resource Data)"**
- IS-3-139: Jialei Chen (Nagoya University)*; Daisuke Deguchi (Nagoya University); Chenkai ZHANG (Nagoya University); Zhenzhen Quan (Shandong University); Hiroshi Murase (Nagoya University), **"Distill from CLIP by Token Alignment for Inductive Zero-shot Semantic Segmentation"**
- IS-3-140: 西村俊彦, 嶋田知泰, 久保宏一郎, 村崎和彦, 吉田大我, 谷田隆一 (NTT), **"階層的な粒度を考慮した点群データからの希少クラス認識に関する検討"**
- IS-3-141: Lucie Kunitomo-Jacquin ( National Institute of Advanced Industrial Science and Technology)*; Ken Fukuda (National Institute of Advanced Industrial Science and Technology), **"Dempster-Shafer理論に基づく述語分類の提案 (Predicate classification based on Dempster-Shafer theory)"**
