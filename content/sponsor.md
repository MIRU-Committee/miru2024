...
- 法人枠での参加登録では会議の聴講と企業展示・企業企画イベントでの発表が可能です。会議において、口頭発表、ポスター発表、デモ発表を行う場合は発表一件につき必ず一名以上の個人登録が必要です。複数人でポスターやデモ発表をする場合は二人目以降に法人枠の参加登録を使うことが可能です。
...
- 背面・側面パネルは幅900mm × 高さ2100mmの画鋲・ピンを設置できるものをブースのサイズ分ご用意する予定です。
...
- 2024年6月30日: ロゴ・動画提出
- <del>2024年7月5日</del> 2024年7月12日: 印刷物・看板・社名板デザイン確認（デザイン案を実行委員会より送付し問題がないかご確認いただきます）
